x# Copyright 2016 Paul Balanca. All Rights Reserved.
#
...
tf.compat.v1.app.flags.DEFINE_float('opt_epsilon', 1.0, 'Epsilon term for the optimizer.')
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        for loss in tf.compat.v1.get_collection('EXTRA_LOSSES', first_clone_scope):
            summaries.add(tf.compat.v1.summary.scalar(loss.op.name, loss))
