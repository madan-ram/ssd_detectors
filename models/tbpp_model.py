...
from models.ssd_model import ssd512_body
from models.ssd_model_dense import dsod512_body
from models.ssd_model_separable import ssd512_dense_separable_body


def multibox_head(source_layers, num_classes, num_priors, normalizations=None, softmax=True):
...
def TBPP512(num_classes, input_shape=(512, 512, 3), softmax=True):
    ...
    output_tensor = multibox_head(source_layers, num_classes, num_priors, normalizations, softmax)
...
def multibox_head_separable(source_layers, num_classes, num_priors, normalizations=None, softmax=True):
...
def TBPP512_dense_separable(num_classes, input_shape=(512, 512, 3), softmax=True):
    ...
    num_priors = [14] * num_maps
    normalizations = [1] * num_maps
    output_tensor = multibox_head_separable(source_layers, num_classes, num_priors, normalizations, softmax)
    model = Model(input_tensor, output_tensor)
